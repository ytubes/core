...
use ytubes\components\bootstrap\ModuleAutoLoader;
...
class ModuleManager extends \yii\base\Component
{
     ...
     * @throws Exception
     */
    public function registerBulk($configs)
    {
     ...
     *
     * Note: Only modules which extends \ytubes\components\Module will be returned.
     *
     ...
     * Enables a module
     *
     * @param \ytubes\components\Module $module
     */
